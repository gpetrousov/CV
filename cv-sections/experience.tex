...
\begin{cventrystack}
	...
	{ % Description(s) of tasks/responsibilities
		\begin{cvitems}
			\item {Working with multiple development teams}
			\item {Deploying infrastructure using various AWS services}
			\item {Implementing monitoring solutions}
			\item {Writting code in Python, BASH, Terraform and Ansible}
			\item {\bfseries{Technologies:} AWS, Python, ECS, Docker, Terraform, SignalFX, Ansible, Apache}
		\end{cvitems}
	}
\end{cventrystack}
\end{minipage}
